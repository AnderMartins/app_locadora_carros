<template>
    <div class="container">
        <div class="row justify-content-center">
            ...
            <card-component titulo="Busca de Marcas">
                <template v-slot:conteudo>
                    <div class="form-row">
                        ...
                        <input type="text" class="form-control" id="inputId" aria-describedby="nomeHelp" placeholder="Nome da Marca" v-model="busca.nome">
                        </input-container-component>
            ...
            <!-- Inicio card de listagens de marcas-->
            ...
            <!-- Final card de listagens de marcas-->
